...
#    print aidx_test
    ...
    neighbor_idx = sort_idx[-1-K_CF:-1]
    ...
    for u in range(0, no_users):
        ...
        for train_aidx, test_aidx in kf:  # for all folds
            ...
            if METHOD == "RB":          # random baseline
                ...
                sorted_idx_top = sorted_idx[-1-K_HR:-1]
...
if __name__ == '__main__':
    ...
    K_CF = 3            # number of nearest neighbors to consider in CB (= users)
    ...
    if True:
        METHOD = "CB"
        for K_CB in range(3, 100):
            print (str(K_CB) + ","),
            run()

    if True:
        METHOD = "CF"
        for K_CF in range(3, 100):
            print (str(K_CF) + ","),
            run()
