...
# contet-based recommender, random recommendation, and a simple hybrid method.
__author__ = 'mms'
    ...
    for u in range(0, no_users):
        ...
        for train_aidx, test_aidx in kf:  # for all folds
            ...
            if METHOD == "RB":          # random baseline
                ...
                rec_aidx = np.union1d(rec_aidx_CB, rec_aidx_CF)     # Perform "set-based fusion". It's as simple as this. :)
